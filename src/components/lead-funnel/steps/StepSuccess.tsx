  ...
  return (
    <div className="flex flex-col items-center justify-center text-center max-w-2xl mx-auto px-6 gap-8">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }}>
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-medium tracking-tighter text-white mb-4">
          Thank you, {formData.fullName}!
        </h1>
        <p className="text-white/50 text-lg">Our team will contact you shortly</p>
      </motion.div>
      ...
      >
        <a
          ...
          className="bg-primary text-navy font-bold uppercase text-xs tracking-[0.2em] px-10 py-4 hover:bg-white transition-all"
        >
          Chat on WhatsApp
        </a>
        <Link
          to="/properties"
          onClick={reset}
          className="border border-white/20 text-white font-bold uppercase text-xs tracking-[0.2em] px-10 py-4 hover:bg-white/10 transition-all"
        >
          Browse Properties
        </Link>
      </motion.div>
